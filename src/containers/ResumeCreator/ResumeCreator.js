...
export class ResumeCreator extends React.Component {
    ...
    fetchResume = async () => {
        ...
        console.log('TCL: ResumeCreator -> fetchResume -> result', result);
    }
    ...
    render() {
        console.log('TCL: ResumeCreator -> render -> this.props.mode', this.props.mode);
        return (
            <div className="">
                <div className="row">
